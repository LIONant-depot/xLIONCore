...
// collider/body authoring + the runtime body id. Size comes from Transform.Scale only
// (unit mesh half-extents 0.5 => world half-extents = 0.5 * Scale).
...
namespace xlioncore::physics
{
    struct rigid_body
    {
        ...
        // m_BodyHalfExtents is the last (0.5 * Scale) pushed into box3d (recreate when Scale drifts).
